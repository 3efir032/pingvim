...
export default function AuthPage({ onAuth, defaultPassword }: AuthPageProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#1B1C1F] text-gray-300 relative overflow-hidden">
      ...
      <div className="w-64 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
        <form className="m-0 p-0" onSubmit={handleSubmit}>
          <div className="relative w-full m-0 p-0 group">
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <Input
              ...
              className={`w-full pl-10 bg-[#1E1F22] border-gray-700 opacity-0 hover:opacity-100 focus:opacity-100 transition-opacity duration-300 ${
